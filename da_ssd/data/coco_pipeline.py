...
class SimplePipeline(Pipeline):
    def __init__(self, path, batch_size, num_threads, device_id, seed, output_fp16=False,
                 output_nhwc=False, pad_output=False):
...
class DALIImageIterator(object):
    """
    COCO DALI iterator for pyTorch.
    ...
    def __next__(self):
        ...
        for i in range(self._num_gpus):
            ...
            self._data_batches[i][self._current_data_batch] = (pyt_images)
