...
def vis_bbox(img, bbox, annotations_path, label=None, score=None, ax=None):
    ...
    label_names = categories_names(annotations_path) + ['bg']
    # add for index `-1`
...
def categories_names(annotation_path: str):
    # json_file = '/datasets/coco2017/annotations/instances_val2017.json'
    with open(annotation_path, 'r') as COCO:
